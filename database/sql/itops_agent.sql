CREATE DATABASE IF NOT EXISTS itops_agent DEFAULT CHARSET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE itops_agent;
...
(
    ...
    `minio_path` VARCHAR(512) NOT NULL COMMENT 'RustFS/MinIO itops-docs 桶内精确存储路径，供 Python Worker 下载原文件',
