package com.ai.itops.common.cache;
...
class KnowledgeCardCacheAnnotationTest {
    ...
    void shouldEvictAllCardCachesForWriteMethods() throws NoSuchMethodException {
        List<Method> writeMethods = List.of(
                method("create", com.ai.itops.card.dto.CardCreateRequest.class),
                method("update", Long.class, com.ai.itops.card.dto.CardUpdateRequest.class),
