...
class BackendPackageRefactorTest {
    ...
    private static final List<String> EXPECTED_CLASSES = List.of(
            ...
            "com.yuyu.fishagent.memory.longterm.MilvusLongTermMemoryStore",
            ...
            "com.yuyu.fishagent.rag.pipeline.recall.PublicKnowledgeMilvusSearcher",
            "com.yuyu.fishagent.rag.pipeline.recall.UserKnowledgeMilvusSearcher",
            "com.yuyu.fishagent.rag.pipeline.recall.UserMemoryMilvusSearcher",
