...
import com.ai.itops.agent.tool.troubleshooting.MockTroubleshootingDataService;
...
import com.ai.itops.agent.tool.troubleshooting.TroubleshootingToolProperties;
import com.ai.itops.chat.router.HeuristicQueryRouter;
import com.ai.itops.chat.router.QueryRoute;
import com.ai.itops.chat.router.QueryRouter;
import com.ai.itops.chat.router.QueryRouterProperties;
...
public class TroubleshootingEvalRunner {
    ...
    private com.ai.itops.common.trace.TraceCollector nullTraceCollector() {
        return new com.ai.itops.common.trace.TraceCollector(new com.ai.itops.common.trace.TraceProperties());
    }
}
